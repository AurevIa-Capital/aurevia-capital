...
def check_website_loaded_successfully(driver: webdriver.Chrome, expected_domain: str = "watchcharts.com") -> bool:
    ...
    try:
        ...
        if success_count >= 2:  # At least 2 success indicators
            ...
            logger.warning(f"Website may not have loaded properly. Found {success_count} success indicators")
            return False
    ...
    try:
        ...
        for indicator in cloudflare_indicators:
            if indicator in page_source:
                logger.warning(f"Cloudflare challenge detected: '{indicator}' found in page")
                return True
                
        # Check page title
        for indicator in title_indicators:
            if indicator in page_title:
                logger.warning(f"Cloudflare challenge detected: '{indicator}' found in title")
                return True
